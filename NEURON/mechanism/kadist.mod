...
:	gkabar = 0.008  (mho/cm2)  :suggested conductance value
	gkabar = 0      (mho/cm2)  :initialized conductance
        vhalfn = -1     (mV)       :activation half-potential    :init
:	vhalfn = 2     (mV)       :activation half-potential     : Israel Johnston
        vhalfl = -56    (mV)       :inactivation half-potential   :init
:       vhalfl = -64    (mV)       :inactivation half-potential   : Israel Johnston
